...
- form으로 제출된 내용은 request.POST에 딕셔너리 형태로 저장됨 : request.POST의 내용 <QueryDict: {'csrfmiddlewaretoken': ['9G5W7A2xwAtAY8BGuPNF06GcLEYaP1R9zny0R3alQRC8EOr93FzBjmJIGik1V3au'], 'task': ['do the dishes'], 'priority': ['1']}>
