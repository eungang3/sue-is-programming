...
## 2. Django Models
 ...
 - Many to Many relationship: A 테이블의 id가 B 테이블의 여러 id와 연결될 수 있고, B 테이블의 id도 A 테이블의 여러 id와 연결될 수 있는 경우. ManyToManyField 사용
 - Many to One relationship: A 테이블의 id가 B 테이블의 여러 id와 연결될 수 있지만, B 테이블은 A 테이블의 한 id만 가질 수 있는 경우. ForeignKey 필드 사용
...
# 정보 출력하기
# __str__ method 없으면 <QuerySet [<Assignments : Assignments object(1)>]> 출력
